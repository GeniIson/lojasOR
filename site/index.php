    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Lojas OR</a>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="container">
          ...
          <h1 class="display-4 fw-bolder">"Aqui tem o melhor negocio para você"</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Compramos e vendemos aparelhos novos e usados!</p>
            <p><a class="btn btn-lg btn-primary" href="cadastrar-formacao.php">Cadastros</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          ...
          <h1 class="display-4 fw-bolder">"Aqui tem o melhor negocio para você"</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Compramos e vendemos aparelhos novos e usados!</p>
            <p><a class="btn btn-lg btn-success" href="cadastrar-curso.php">Ver tarefas</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
