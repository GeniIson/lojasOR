...
<a class="col mb-5" style="padding: 10px;margin: 0; text-decoration: none; color: black;" href="?produto=<?=$id_an?>">
...
<div class="card h-100" style="padding: -10px; margin: 0px; ">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="../../arquivos_fixos_importante_or/capas/<?=$capa_arquivo?>" alt="..." />
                            <!-- Product details-->
...
<div class="text-center"style="padding: -10px; margin: 0px; "></div>
                            </div> 
                        </div>
                    </div></a>
