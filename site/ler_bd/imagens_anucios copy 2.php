...
<!-- Modal -->
<!-- Modal -->
<div class="modal fade" id="imagemModal<?=$id_f?>" tabindex="-1" role="dialog" aria-labelledby="imagemModalLabel" aria-hidden="true" >
    ...
    <div class="modal-content" >
      ...
      <div ></div>
        <div class="zoom-container " >
          <img src="" alt="" id="imagemModalImg<?=$id_f?>" class="img-fluid draggable">
        </div>
      </div>
      <div class="modal-footer fixed-bottom">
       
      <button type="button" class='btn' id="zoomInBtn<?=$id_f?>" ><i class="bi bi-zoom-in"></i></button>
        <button type="button" class='btn' id="zoomOutBtn<?=$id_f?>"><i class="bi bi-zoom-out"></i></button>
      </div>
    </div>
    </div>
